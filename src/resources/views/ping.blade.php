...
<x-pulse::card :cols="$cols" :rows="$rows" :class="$class">
    ...
    html.dark #anourvalar-ping-svg {fill: #9ca3af !important;}
    html:not(.dark) #anourvalar-ping-svg {fill: #4b5563 !important;}
    </style>
</x-pulse::card>
