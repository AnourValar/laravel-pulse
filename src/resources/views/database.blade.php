...
<x-pulse::card :cols="$cols" :rows="$rows" :class="$class">
    ...
    html.dark #anourvalar-database-svg {fill: #9ca3af !important;}
    html:not(.dark) #anourvalar-database-svg {fill: #4b5563 !important;}
    </style>
</x-pulse::card>
